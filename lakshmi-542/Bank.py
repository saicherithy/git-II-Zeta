...
class Account:
    def _init_(self, account_number, holder_name, balance):
...
class SavingsAccount(Account):
    def _init_(self, account_number, holder_name, balance, minimum_balance):
        super()._init_(account_number, holder_name, balance)
...
class CurrentAccount(Account):
    def _init_(self, account_number, holder_name, balance, overdraft_limit):
        super()._init_(account_number, holder_name, balance)
